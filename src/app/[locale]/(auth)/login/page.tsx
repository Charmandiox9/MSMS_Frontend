  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center bg-background relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <Link href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors mb-6 group">
          <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
          {t('back')}
        </Link>

        <div className="bg-card border border-border rounded-[2rem] shadow-xl p-8 sm:p-10 flex flex-col items-center text-center">
          ...
          <a href="http://localhost:3001/api/auth/google" className="w-full flex items-center justify-center gap-3 bg-card border-2 border-border hover:border-foreground/20 hover:bg-muted text-foreground py-3.5 px-4 rounded-[1rem] shadow-sm hover:shadow-md transition-all font-bold group">
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-[11px] font-bold uppercase tracking-wider text-muted-foreground bg-muted px-4 py-2 rounded-lg border border-border">
