...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background overflow-x-hidden selection:bg-primary/20">
      ...
      {/* HERO SECTION */}
      <section className="bg-foreground/5 relative py-20 px-6 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <p className="text-foreground/70 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            {t('subtitle')}
          </p>
        </div>
      </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div key={idx} className="bg-background border border-foreground/10 p-8 rounded-3xl text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default group">
        ...
        <section className="pt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {[
              ...
              <a key={idx} href={tech.url} target="_blank" rel="noopener noreferrer" className="border border-foreground/10 p-6 rounded-3xl flex flex-col items-center justify-center text-center bg-foreground/5 hover:bg-background hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
        ...
        <section className="pt-8 pb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={idx} className="p-8 bg-background border border-foreground/10 rounded-[2rem] shadow-sm flex flex-col justify-between hover:shadow-xl hover:border-primary/30 transition-all duration-300 group relative overflow-hidden">
                <div className="absolute top-0 inset-x-0 h-24 bg-foreground/5 rounded-t-[2rem]"></div>
                ...
                <div className="mt-4 pt-6 border-t border-foreground/5 flex items-center justify-center gap-4">
                  <a href={dev.github} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 py-3 bg-foreground/5 hover:bg-foreground/10 rounded-xl text-foreground/80 hover:text-foreground transition-colors text-sm font-bold">
