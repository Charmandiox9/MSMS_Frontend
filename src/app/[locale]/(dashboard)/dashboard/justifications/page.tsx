...
export default function JustificationsPage() {
  ...
  const decide = async (status: Exclude<JustificationStatus, 'PENDING'>, category: JustificationReasonCategory) => {
    ...
    try {
      ...
      setSelected({ ...updated, teachers: selected.teachers });
      setRejectReason('');
